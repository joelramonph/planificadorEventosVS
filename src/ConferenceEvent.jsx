        ...
        return (
            <>
                <nav className="nav_event_conference">
                    ...
                    <button className="details_button" onClick={() => setShowItems(!showItems)}>Show Detail</button>
                </nav>
                                            ...
                                            <div className="venue_main" key={index}>
                                                ...
                                                <div className="buttom_container">
                                                    {venueItems[index.name] === "Auditorium Hall (Capacity:200)" ? (
                                                        ...
                                                        <>
                                                            <button className={venueItems[index].quantity === 0 ? "btn-warning btn-disabled" : "btn-minus btn-warning"}
